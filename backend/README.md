...
## Project Structure
    ...
    ├── solitary_glitter_de_75020  # Django project configurations
...
1. Clone this repo and `cd solitary_glitter_de_75020`
...
2. Clone this repo and `cd solitary_glitter_de_75020`
